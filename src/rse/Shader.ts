...
namespace rse {
    ...
    export class Shader {
        ...
        setUniformInt(index:WebGLUniformLocation, value:number) {
            gl.uniform1i(index, value);
        }

        setUniformFloat(index:WebGLUniformLocation, value:number) {
            gl.uniform1f(index, value);
        }

        setUniformVec4(index:WebGLUniformLocation, value:Vec4) {
            gl.uniform4f(index, value.x, value.y, value.z, value.w);
        }

        setUniformColor(index:WebGLUniformLocation, value:Color) {
